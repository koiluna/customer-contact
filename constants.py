...
DB_NAMES = {
    ...
    DB_ECONOMY_PATH: f"{RAG_TOP_FOLDER_PATH}/economy"
}
...
SEARCH_ECONOMY_INFO_TOOL_NAME = "search_economy_tool"
SEARCH_ECONOMY_INFO_TOOL_DESCRIPTION = "金融経済に関する情報を参照したい時に使う"
...
SYSTEM_PROMPT_EMPLOYEE_SELECTION = """
    ...
    従業員の「ID」、「氏名」「抽出理由」をカンマ区切りで返してください。
    ...
    全ての従業員の従業員ID、従業員名、その理由をカンマ区切りで返してください。ただし、関連性が低い（対応者候補に含めるべきでない）
    と判断した場合は省いてください。
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    【メンション先の選定理由】
    {context.employee_name}は、{context.reason}
